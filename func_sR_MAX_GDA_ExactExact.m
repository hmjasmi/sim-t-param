function [sum_rate, opt] = func_sR_MAX_GDA_ExactExact(H_RI, H_IT, Tl, N_0, properties)
% This function maximizes the sum rate of the system using GDA
% The channel model for optimization is Exact
% The channel model for returned optimal channel is Exact 
    ...
    while true
        ...
        f_old = compute_sum_rate(theta, H_RI, H_IT, Tl, N, L, N_0);
        sum_rate(iter) = f_old;
        ...
        for l = 1:L
            for n = 1:N
                ...
                f_plus = compute_sum_rate(theta_plus, H_RI, H_IT, Tl, N, L, N_0);
        ...
        f_cand = compute_sum_rate(theta_cand, H_RI, H_IT, Tl, N, L, N_0);
